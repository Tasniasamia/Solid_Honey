          ...
          <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <table className="w-full">
                      <thead>
                        <tr>
                          ...
                          <th className="p-2 text-left border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-base"></th>
                          <th className="w-10 text-right pr-4 pl-2 text-blue-900 cursor-pointer">
                            Save/Add
                          </th>
                        </tr>
                      </thead>
                  ...
                  <tbody>
                    ...
                    <tr className="bg-white border-b border-blue-500">
                      <td className="py-2 px-4 bg-gray-300">
                        পরিমান :{" "}
                        <span className="w-full text-center bg-white pr-20">
                          {" "}
                          0.00
                        </span>
                      </td>
            ...
            <div className="md:w-1/4">
              <h2 className="text-lg font-semibold mb-4">
                <span onClick={() => setTab("calculation")}>হিসাব/নিকাশ </span>
                <span
                  class="bg-gray-400 p-2 rounded-xl text-white cursor-pointer"
                ...
                {tab === "calculation" ? (
                  ...
                  <div className="mt-4">
                    ...
                    <div className="relative mt-2">
                      ...
                      />
                      <FiSearch className="absolute top-3.5 right-2.5 text-gray-500 cursor-pointer" onClick={handleSearch}/>
                    </div>
                  </div>
                )}
                <button
