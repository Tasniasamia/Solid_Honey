...
const SellPage = () => {
    ...
    const searchHandlerWithNumber = async (e) => {
        ...
        await instance.post(`${import.meta.env.VITE_BACKEND_URL}/saler/product/salce/user/search/`, {phone_number: value}).then(({data}) =>{
            setUserData(data)
            console.log(data);
        }).catch(({response}) => {
                ...
                <div className="md:w-3/4">
                    ...
                    <form onSubmit={sellSubmitHandler} ref={sellFormRef}>
                        <table className="w-full">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <input defaultValue={userData?.user?.name} className='border-black p-1 bg-gray-200 rounded-lg mt-1' type="text" name="name" id="" placeholder="Enter a text "/>
                                </tr>
                                <tr>
                                    ...
                                    <input onKeyUp={searchHandlerWithNumber} className='border-black p-1 bg-gray-200 rounded-lg mt-1' type="number" name="phone_number" id="" placeholder="Enter Phone Number "/>
                                </tr>
                                <tr>
                                    ...
                                    <th className="text-left font-semibold">ঠিকানা {userData?.user?.address && <input onChange={() => setShowAddress(prev => !prev)} checked={showAddress} type='checkbox' />} </th>
                                    <input defaultValue={(userData && showAddress) ? userData?.user?.address : ""} className='border-black p-1 bg-gray-200 rounded-lg mt-1' type="text" name="address" id="" placeholder="Enter a text "/>
                                </tr>
                                <tr>
                                    ...
                                    <input defaultValue={userData?.user?.remarks} className='border-black p-1 bg-gray-200 rounded-lg mt-1' type="text" name="comment" id="" placeholder="Enter a text "/>
                                </tr>
                            </thead>
                        ...
                        <tbody>
                            <tr className="bg-white border-b border-blue-500">
                                ...
                                <td colSpan={2} className="py-2 px-4">
                                    <select className="py-2 px-4 w-full" name="dhoron" id="">
                                        <option value="">Select ..</option>
                            ...
                            <tr className="bg-white border-b border-blue-500">
                                <td className="py-2 px-4 bg-gray-300">পরিমান : <input onKeyUp={calCulateTotalPoriman} name='poriman' className='w-full text-center bg-white pr-20' />
                                </td>
                                <td className="py-2 px-4 bg-gray-300">দর : <input onKeyUp={calCulateTotalDhor} name='dhor' className='w-full text-center bg-white pr-20'/>
                                </td>
                                <td className="py-2 px-4 bg-gray-300">মোট : <input onChange={() => setMotValueChange(e.target.value)} value={totlaDhor} name='mot' className='w-full text-center bg-white pr-20'/>
                                </td>
                            </tr>
                        </tbody>
                        </table>
                        ...
                        <div className="container mx-auto mt-4">
                            ...
                            {sellProduct?.length > 0 && <Button onClick={submitHandler} className='mt-5'>Save</Button>}
